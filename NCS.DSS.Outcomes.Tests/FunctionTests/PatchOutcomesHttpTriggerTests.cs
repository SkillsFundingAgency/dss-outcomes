...
namespace NCS.DSS.Outcomes.Tests.FunctionTests
{
    ...
    public class PatchOutcomesHttpTriggerTests
    {
        ...
        public async Task PatchOutcomesHttpTrigger_ReturnsStatusCodeNoContent_WhenInteractionDoesNotExist()
        {
            ...
            _resourceHelper.DoesInteractionResourceExistAndBelongToCustomer(Arg.Any<Guid>(), Arg.Any<Guid>())
                .Returns(false);
        ...
        public async Task PatchOutcomesHttpTrigger_ReturnsStatusCodeBadRequest_WhenUnableToUpdateOutcomesRecord()
        {
            ...
            _patchOutcomesHttpTriggerService.UpdateAsync(Arg.Any<string>(), Arg.Any<OutcomesPatch>(), Arg.Any<Guid>())
        ...
        private async Task<HttpResponseMessage> RunFunction(string customerId, string interactionId,
            string actionPlanId, string outcomeId, string sessionId)
        {
